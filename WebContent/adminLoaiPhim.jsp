	...
	<body>
	  ...
	  <header id="header" class="header fixed-top d-flex align-items-center">
	    ...
	    <div class="search-bar">
	      <form class="search-form d-flex align-items-center" method="POST" action="adminLoaiSearchController">
	    ...
	    <ul class="sidebar-nav" id="sidebar-nav">
	      ...
	      <li class="nav-item">
	        ...
	        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
	          ...
	          <li>
	            <a href="adminLoaiController" class="active">
...
<!-- 	      <nav>
	        ...
	        <div class="col-lg-12">
	          ...
	          <div class="card">
	            <div class="card-body table-responsive">
	              <h5 class="card-title">Loại Phim</h5>
	              <!-- Table with stripped rows -->
	              <form class="row g-3" method="post" action="adminLoaiController">
	                <div class="col-md-12">
	                  <label for="inputName5" class="form-label">Mã Loại Phim</label>
	                  <input type="text" class="form-control" id="inputName5" name="maloai" value="<%= (maloai == null) ? ' ': maloai %>">
	                </div>
	                <div class="col-12">
	                  <label for="inputAddress5" class="form-label">Tên Loại Phim</label>
	                  <input type="text" class="form-control" id="inputAddres5s" name="tenloai" value="<%= (tenloai == null) ? ' ': tenloai %>">
	                </div>
	                <div class="text-center">
	                  <button name="them" type="submit" class="btn btn-primary">Thêm</button>
	                  <button name="sua" type="submit" class="btn btn-secondary">Sửa</button>
	                </div>
	              </form>
        ...
        <div class="col-lg-12">
	          ...
	          <div class="card">
	            <div class="card-body table-responsive">
	              <h5 class="card-title">Danh sách loại phim</h5>
	              <% 
	              ...
	              <table class="table table-bordered">
	                ...
	                <% 
	                  int n = dsloai.size();
	                  for(int i = 0; i < n; i++) {
	            		loaibean a = dsloai.get(i);
	                %>
	                  <tr>
	                  	<th scope="col"><%=i %></th>
	                  	<th scope="col"><%=a.getMaloai() %></th>
	                  	<th scope="col"><%=a.getTenloai() %></th>
	                    <th scope="col">
	                    	<a href="adminLoaiController?ml=<%=a.getMaloai() %>&tl=<%=a.getTenloai() %>&tab=chon">Chọn</a>
	                    </th>
	                    <th scope="col">
	                    	<a href="adminLoaiController?ml=<%=a.getMaloai() %>&tab=xoa">Xóa</a>
	                    </th>
	                  </tr>
	                  <%} %>
	                </tbody>
	              ...
	              <%} else { %>
	              	<p class="text-center">Không có thể loại phim nào~</p>
	              <%} %>
	            </div>
	          </div>
        </div>
