	    ...
	    <ul class="sidebar-nav" id="sidebar-nav">
	      ...
	      <li class="nav-item">
	        ...
	        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
	          <li>
	            <a href="adminXacNhanHDController" class="active">
	        ...
	        <div class="col-lg-12">
	          ...
	          <div class="card">
	            <div class="card-body table-responsive">
				  ...
				  <%
					  ArrayList<xacNhanHDbean> dshd = (ArrayList<xacNhanHDbean>)request.getAttribute("dshd"); 
	              	  if(dshd.size() > 0) {
				  %>
	              <table class="table table-bordered">
	                ...
	                <%
	                	int n = dshd.size();
	                	for(int i = 0; i < n; i++) {
	                		xacNhanHDbean a = dshd.get(i);
	                %>
	                  <tr>
	                   	<th scope="col"><%=i %></th>
	                   	<th scope="col"><%=a.getMahd() %></th>
	                   	<th scope="col"><%=a.getTenkh() %></th>
	                   	<th scope="col"><%=a.getTong() %></th>
	                   	<th scope="col"><%=a.getNgaymua() %></th>
	                    <th scope="col">
	                    	<a href="adminXacNhanHDController?mahd=<%=a.getMahd()%>">Xác nhận</a>
	                    </th>
	                    <th scope="col">
	                    	<a href="adminXacNhanCTController?mahd=<%=a.getMahd()%>">Chi tiết</a>
	                    </th>
	                  </tr>
	                  <%} %>
	                </tbody>
	              ...
	              <%} else { %>
	              	<h5>Chưa có hóa đơn nào được lập~</h5>
	              <%} %>
	            </div>
	          </div>
        </div>
